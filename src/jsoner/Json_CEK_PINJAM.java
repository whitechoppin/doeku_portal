...
import nontrx.CEK_PINJAM;
import org.json.simple.JSONObject;
import org.json.simple.parser.JSONParser;


public class Json_CEK_PINJAM {
  public String Records,getid,getpass,getcounter,hasil;
  
    public Json_CEK_PINJAM(String Records) throws Exception {
    ...
    JSONParser parser = new JSONParser();
        ...
        CEK_PINJAM lg = new CEK_PINJAM(getid,getcounter);
        hasil = lg.getAns();
  }
