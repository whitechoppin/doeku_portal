...
public class Json_ACC_IDN {
  public String Records,getid,getcounter,hasil;
  
    public Json_ACC_IDN(String Records) throws Exception {
    ...
    JSONParser parser = new JSONParser();
        ...
        try {
            ...
            getid = jsonObject.get("no_idn").toString();
        ...
        ACC_IDN ai = new ACC_IDN(getid,getcounter);
        hasil = ai.getAns();
  }
