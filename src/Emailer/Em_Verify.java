...
public class Em_Verify {
        ...
        private static final String EMAIL_SUBJECT = "Verifikasi Akun";
    ...
    public void SendEm(String em,String code) {
        ...
        EMAIL_TO = em; 
        String linkku = "https://doeku.id/email-confirmation/"+code+"/PAB";
        //String linkku = "<a href='https://doeku.id/form/peminjam/forget-password/"+code+"'>Reset Pass</a>";
        //String linkku = "123";
        EMAIL_TEXT = "Klik Untuk Verifikasi Akun DoeKu Anda : "+linkku+" Terima Kasih.";
...
"</html>";
    ...
    public static void main(String[] args) {
            Em_Verify em = new Em_Verify();
            em.SendEm("vt3st3r@gmail.com","12345");
    }
