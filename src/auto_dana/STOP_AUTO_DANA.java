 ...
 * @author VINCENT
 */
public class STOP_AUTO_DANA extends Konf{
    ...
    public STOP_AUTO_DANA(String getidku,String getctr) throws Exception {
        
        try{
            //Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            statv = con.prepareCall("{ call STOP_AUTO_DANA(?,?) }");
