 ...
 * @author VINCENT
 */
public class LIST_ACC_PINJAM extends Konf{
    ...
    public LIST_ACC_PINJAM(String idku,String cntr) {
        
        try{
            //Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            statv = con.prepareCall("{ call LIST_ACC_PINJAM(?,?,?)}");
            ...
            if(hasilx.equalsIgnoreCase("1")) {
                ...
                while(rs.next()){
                    hitung++;
                    String a = rs.getString("a.id_trxbrw");
                    String b = rs.getString("c.nama");
                    String c = rs.getString("b.jumlah");
                    String d = rs.getString("b.tenor");
                    String e = rs.getString("b.tgl_akhir");
                    String f = rs.getString("b.jum_fix");
                    String g = rs.getString("b.status");
                    String h = rs.getString("b.bunga_brw");
                    String i = rs.getString("b.jum_fix");
                    //bunga
                    //denda
                    //total bayar
                    
                    jo2.put("urut",hitung);
                    jo2.put("id_pinjaman",a);
                    jo2.put("nama",b);
                    jo2.put("jumlah",c);
                    jo2.put("tenor",d);
                    jo2.put("bunga",bungaku);
                    jo2.put("denda",dendaku);
                    jo2.put("Total",f);
                    jo2.put("Status",g);
                    jo2.put("bunga",h);
                    jo2.put("jatuh_tempo",e);
