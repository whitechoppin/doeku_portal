 ...
 * @author VINCENT
 */
public class RESET_PASS_CONF extends Konf{
    ...
    public RESET_PASS_CONF(String baru,String unik,String pos,String cntr) {
        
        try{
            //Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            statv = con.prepareCall("{ call RESET_PASS_X(?,?,?,?,?)}");
            
            statv.setString(1,baru);
            statv.setString(2,pos);
            statv.setString(3,unik);
