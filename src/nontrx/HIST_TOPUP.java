 ...
 * @author VINCENT
 */
public class HIST_TOPUP extends Konf{
    ...
    public HIST_TOPUP(String idku,String tgl_mulai,String tgl_akhir,String cntr) {
        
        try{
            //Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            statv = con.prepareCall("{ call HIST_TOPUP_IDN(?,?,?,?)}");
