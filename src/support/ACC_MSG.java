 ...
 * @author VINCENT
 */
public class ACC_MSG extends Konf{
    ...
    public ACC_MSG(String getid,String getjudul,String getdiv,String getlevel,String getisi,String getctr) {
        
        try{
            //Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            statv = con.prepareCall("{ call MSG_ACC(?,?,?,?,?,?,?,?) }");
            statv.setString(1,getid);
            statv.setString(2,getjudul);
            statv.setString(3,getdiv);
            statv.setString(4,getlevel);
            statv.setString(5,getisi);
